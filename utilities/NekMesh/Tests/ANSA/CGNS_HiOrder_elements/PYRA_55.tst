...
<test>
  <description> NekMesh with CGNS for high order pyramid</description>
    <segment type="sequential">
      <executable>NekMesh</executable>
      <parameters>  PYRA_55.cgns out.xml  </parameters>
    ...
    <files>
      <file description="Input File">PYRA_55.cgns</file>
    </files>
    <metrics>
