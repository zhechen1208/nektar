...
<test>
    <description>2D unsteady advection MODIFIED, P=10, homogeneous Dirichlet bcs, deformed elements</description>
    ...
    <metrics>
        ...
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-12"> 0.0643516 </value>
        </metric>
    </metrics>
</test>
