...
<test>
    <description>3D Tet Kovasnay solution using LORPreconditioner only for Pressure</description>
    <executable>IncNavierStokesSolver</executable>
    <parameters>Tet_Kovasnay_PreconditionerLOR_pressure.xml</parameters>
    <files>
        <file description="Session File">Tet_Kovasnay_PreconditionerLOR_pressure.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
