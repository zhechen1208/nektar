...
<test>
    <description>3D channel flow, Prismatic elements, P=6, LOR for Prisms</description>
    <executable>IncNavierStokesSolver</executable>
    <parameters>Prism_channel_PreconditionerLOR.xml</parameters>
    <files>
        <file description="Session File">Prism_channel_PreconditionerLOR.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
