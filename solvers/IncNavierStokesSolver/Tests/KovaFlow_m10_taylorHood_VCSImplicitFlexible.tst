...
<test>
    ...
    <parameters>KovaFlow_m10_taylorHood_VCSImplicitFlexible.xml</parameters>
    <files>
        <file description="Session File">KovaFlow_m10_taylorHood_VCSImplicitFlexible.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
