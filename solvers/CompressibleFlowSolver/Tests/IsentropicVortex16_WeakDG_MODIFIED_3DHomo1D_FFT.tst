...
<test>
    <description>Euler Isentropic Vortex P=4, WeakDG, MODIFIED</description>
    <executable>CompressibleFlowSolver</executable>
    <parameters>IsentropicVortex16_WeakDG_MODIFIED_3DHomo1D_FFT.xml</parameters>
    <files>
        <file description="Session File">IsentropicVortex16_WeakDG_MODIFIED_3DHomo1D_FFT.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
