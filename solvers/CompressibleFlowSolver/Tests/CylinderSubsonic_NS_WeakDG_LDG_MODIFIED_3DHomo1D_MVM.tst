...
<test>
    ...
    <parameters>CylinderSubsonic_NS_WeakDG_LDG_MODIFIED_3DHomo1D_MVM.xml</parameters>
    <files>
        <file description="Session File">CylinderSubsonic_NS_WeakDG_LDG_MODIFIED_3DHomo1D_MVM.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
