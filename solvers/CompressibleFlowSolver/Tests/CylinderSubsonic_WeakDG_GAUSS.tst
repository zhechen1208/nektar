...
<test>
    <description>Euler, Subsonic Cylinder, Dirichlet bcs, WeakDG, GAUSS</description>
    <executable>CompressibleFlowSolver</executable>
    <parameters>CylinderSubsonic_WeakDG_GAUSS.xml</parameters>
    <files>
        <file description="Session File">CylinderSubsonic_WeakDG_GAUSS.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
