...
<test>
    ...
    <parameters>Couette_WeakDG_LDG_MODIFIED_3DHOMO1D_FFT.xml</parameters>
    <files>
        <file description="Session File">Couette_WeakDG_LDG_MODIFIED_3DHOMO1D_FFT.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
            <value variable="rho" tolerance="1e-09">0.000683625</value>
            <value variable="rhou" tolerance="1e-04">68.0612</value>
            <value variable="rhov" tolerance="1e-06">0.25079</value>
