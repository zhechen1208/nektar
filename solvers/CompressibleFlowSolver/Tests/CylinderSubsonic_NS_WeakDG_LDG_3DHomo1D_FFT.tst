...
<test>
    ...
    <parameters>CylinderSubsonic_NS_WeakDG_LDG_3DHomo1D_FFT.xml</parameters>
    <files>
        <file description="Session File">CylinderSubsonic_NS_WeakDG_LDG_3DHomo1D_FFT.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
